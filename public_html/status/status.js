window.onload = () => {
    ...
    // Send a request
    xHttpServer.open('GET', 'https://oldchicken.myweb.cs.uwindsor.ca/services/ping.php?type=server');
    ...
    // Send a request
    xHttpDB.open('GET', 'https://oldchicken.myweb.cs.uwindsor.ca/services/ping.php?type=db');
