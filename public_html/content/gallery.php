...
<div class="container pt-5 page-background min_height">
    ...
    <div class="row d-flex justify-content-center align-items-center h-100 m-3">
        <div class="col-11 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mt-5">
            <div class="card h-100 p-3 background text-color rounded-5 shadow hover_expand">
                <div class="card-body">
                    <h5 class="card-title">Custom PC Build #1</h5>
                    <img class="rounded img-fluid" src="../static/custom_build_1.jpeg" alt="Custom PC #1">
        ...
        <div class="col-11 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mt-5">
            <div class="card h-100 p-3 background text-color rounded-5 shadow hover_expand">
                <div class="card-body">
                    ...
                    <img class="rounded img-fluid" src="../static/custom_build_2.jpeg" alt="Custom PC #2">
                    <h5 class="card-title"><br>Parts List:</h5>
                    <h6 class="card-subtitle text-success my-2">
        ...
        <div class="col-11 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mt-5">
            <div class="card h-100 p-3 background text-color rounded-5 shadow hover_expand">
                <div class="card-body">
                    ...
                    <img class="rounded img-fluid" src="../static/custom_build_3.jpeg" alt="Custom PC #3">
                    <h5 class="card-title"><br>Parts List:</h5>
                    <h6 class="card-subtitle text-success my-2">
                        CPU - Intel Core i7-7660U<br>
                        GPU - EVGA Geforce RTX 2080 TI</h6>
                </div>
            </div>
        </div>
        <div class="col-11 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mt-5">
            <div class="card h-100 p-3 background text-color rounded-5 shadow hover_expand">
                <div class="card-body">
                    ...
                    <img class="rounded img-fluid" src="../static/custom_build_4.jpeg" alt="Custom PC #4">
                    <h5 class="card-title"><br>Parts List:</h5>
                    <h6 class="card-subtitle text-success my-2">
        ...
        <div class="col-11 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mt-5">
            <div class="card h-100 p-3 background text-color rounded-5 shadow hover_expand">
                <div class="card-body">
                    ...
                    <img class="rounded img-fluid" src="../static/custom_build_5.jpeg" alt="Custom PC #5">
                    <h5 class="card-title"><br>Parts List:</h5>
                    <h6 class="card-subtitle text-success my-2">
                        CPU - AMD Ryzen 5 3600<br>
        ...
        <div class="col-11 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mt-5">
            <div class="card h-100 p-3 background text-color rounded-5 shadow hover_expand">
                <div class="card-body">
                    ...
                    <img class="rounded img-fluid" src="../static/custom_build_6.jpeg" alt="Custom PC #6">
                    <h5 class="card-title"><br>Parts List:</h5>
                    <h6 class="card-subtitle text-success my-2">
