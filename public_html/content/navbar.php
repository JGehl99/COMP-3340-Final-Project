            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <?php } else { ?>
                    ...
                    <li class="nav-item dropdown d-none d-sm-none d-md-block d-lg-block d-lx-block d-xxl-block bg-light">
                        <a class="nav-link link-dark dropdown-toggle" href="#" id="navbarDropdown" role="button"
                           data-bs-toggle="dropdown" aria-expanded="false">
                            My Account
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end bg-light" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item link-dark" href="account_homepage.php">Account Homepage</a></li>
